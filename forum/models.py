...
class ForumThread(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('forum:thread_detail', kwargs={'category_slug': self.category.slug, 'thread_slug': self.slug})
...
class ForumPost(models.Model):
    ...
    # If we implement editing posts:
    # def save(self, *args, **kwargs):
    #     is_new = self.pk is None
    #     super().save(*args, **kwargs)
    #     if is_new: # Only update thread on new post creation
